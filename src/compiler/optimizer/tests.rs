            ...
            if let crate::compiler::parser::ast::Definition::FunctionDef { body, .. } = def {
                for stmt in &body.statements {
                    if let crate::compiler::parser::ast::Statement::Use { value, .. } = stmt {
                        ...
                        if let crate::compiler::parser::ast::Expr::Literal { kind: crate::compiler::parser::ast::LiteralKind::Uint(8) } = folded {
            ...
            if let crate::compiler::parser::ast::Definition::FunctionDef { body, .. } = def {
                for stmt in &body.statements {
                    if let crate::compiler::parser::ast::Statement::Use { value, .. } = stmt {
                        ...
                        if let crate::compiler::parser::ast::Expr::Literal { kind: crate::compiler::parser::ast::LiteralKind::Uint(20) } = folded {
                            // Success! Constants were folded
                        }
                    }
                }
